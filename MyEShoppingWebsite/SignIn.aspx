    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        ...
        <div class="form-inline my-2 my-lg-0">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="SignIn.aspx">Sign In</a></li>
                    </ul>
    </nav>
</div>
            </div>
       ...
       <div class="center-page">
           ...
           <label class="col-xs-11">Email</label>
            <div class="col-xs-11">
                ...
                <asp:RequiredFieldValidator ID="rfdEmail" runat="server" ErrorMessage="Enter Valid Email" ControlToValidate="tbEmail" ForeColor="Red" CssClass="alert-danger"></asp:RequiredFieldValidator>
                 &nbsp;&nbsp;&nbsp;
                 <asp:RegularExpressionValidator ID="revEmail" runat="server" ErrorMessage="Proper Email address" ControlToValidate="tbEmail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
            </div>
           
            <label class="col-xs-11">Password</label>
            <div class="col-xs-11">
                <asp:TextBox ID="tbPass" runat="server" Class="form-control" placeholder="Password" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="Enter Valid Password" ControlToValidate="tbPass" ForeColor="Red" CssClass="alert-danger"></asp:RequiredFieldValidator>
            
            </div>
           
                       <label class="col-xs-11">
              <asp:CheckBox ID="ckbRemeber" runat="server" /> 
            &nbsp;Remember Me</label>
          ...
          <div class="col-xs-11 space-vert">
                <asp:Button ID="btnSignIn" runat="server" Class="btn btn-success" Text="Sign In" OnClick="btnSignIn_Click"/>
